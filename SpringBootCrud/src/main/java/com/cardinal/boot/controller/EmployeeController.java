...
package com.cardinal.boot.controller;
...
import com.cardinal.boot.repository.EmployeeRepository;
...
public class EmployeeController {
	...
	public ResponseEntity<Employee> getEmployeeById(@PathVariable(value = "id") Long employeeId) // String
	...
	public ResponseEntity<Employee> updateEmployee(@PathVariable(value = "id") Long employeeId, // String
